...
#SBATCH --job-name=TB17_LD
#SBATCH --mem=8G 
#SBATCH --ntasks=4 
#SBATCH -e TB17_LD_%A_%a.err 
#SBATCH --time=1:00:00 
...
plink --file /home/jamcgirr/ph/data/plink/population_TB17_ph_filtered_snps_minDP600_maxDP2000_minQ20_minMQ30_NS0.5_maf0.05 --r2 --out /home/jamcgirr/ph/data/plink/population_TB17_ph_filtered_snps_minDP600_maxDP2000_minQ20_minMQ30_NS0.5_maf0.05_r2 --threads 4 
