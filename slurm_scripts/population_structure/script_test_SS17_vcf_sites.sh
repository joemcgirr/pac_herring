...
#SBATCH --job-name=test_SS17_vcf_sites
#SBATCH --mem=20G 
#SBATCH --ntasks=8 
#SBATCH -e test_SS17_vcf_sites_%A_%a.err 
...
/home/jamcgirr/apps/angsd_sep_20/angsd/misc/realSFS SS17_bams.saf.idx -P 8 -fold 1 > SS17_bams_fold_vcf_sites.sfs
/home/jamcgirr/apps/angsd_sep_20/angsd/misc/realSFS saf2theta SS17_bams.saf.idx -outname SS17_bams_fold_vcf_sites -sfs SS17_bams_fold_vcf_sites.sfs -fold 1
/home/jamcgirr/apps/angsd_sep_20/angsd/misc/thetaStat do_stat SS17_bams_fold_vcf_sites.thetas.idx 
/home/jamcgirr/apps/angsd_sep_20/angsd/misc/thetaStat do_stat SS17_bams_fold_vcf_sites.thetas.idx -win 50000 -step 10000 -outnames SS17_bams_fold_vcf_sites.thetasWindow.gz
  
#command to run: sbatch script_test_SS17_vcf_sites.sh