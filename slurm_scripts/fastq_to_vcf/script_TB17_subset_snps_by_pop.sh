...
vcftools --gzvcf /home/jamcgirr/ph/data/combine_gvcfs/population_TB17_snps.vcf.gz --max-missing 0.5 --recode-INFO-all --recode --stdout | bgzip -c > /home/jamcgirr/ph/data/combine_gvcfs/population_TB17_filtered_snps.vcf.gz 
