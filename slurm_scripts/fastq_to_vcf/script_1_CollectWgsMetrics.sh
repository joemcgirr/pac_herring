...
#SBATCH --job-name=1_CollectWgsMetrics
#SBATCH --mem=8G 
#SBATCH --ntasks=4 
#SBATCH -e 1_CollectWgsMetrics_%A_%a.err 
...
for file in /home/eoziolor/phpopg/data/align/1*.bam
do
...
#command to run: sbatch script_1_CollectWgsMetrics.sh