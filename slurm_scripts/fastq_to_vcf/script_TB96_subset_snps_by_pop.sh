...
vcftools --gzvcf /home/jamcgirr/ph/data/combine_gvcfs/population_TB96_snps.vcf.gz --max-missing 0.25 --recode-INFO-all --recode --stdout | bgzip -c > /home/jamcgirr/ph/data/combine_gvcfs/population_TB96_filtered_snps.vcf.gz 
