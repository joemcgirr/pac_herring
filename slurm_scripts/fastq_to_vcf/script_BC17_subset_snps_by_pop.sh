...
vcftools --gzvcf /home/jamcgirr/ph/data/combine_gvcfs/population_BC17_snps.vcf.gz --max-missing 0.8 --recode-INFO-all --recode --stdout | bgzip -c > /home/jamcgirr/ph/data/combine_gvcfs/population_BC17_filtered_snps.vcf.gz 
