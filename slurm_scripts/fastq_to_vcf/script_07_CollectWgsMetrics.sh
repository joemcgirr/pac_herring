...
#SBATCH --job-name=07_CollectWgsMetrics
#SBATCH --mem=8G 
#SBATCH --ntasks=4 
#SBATCH -e 07_CollectWgsMetrics_%A_%a.err 
...
for file in /home/eoziolor/phpopg/data/align/07*.bam
do
...
#command to run: sbatch script_07_CollectWgsMetrics.sh