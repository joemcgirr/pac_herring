...
#SBATCH --job-name=pixy_chr1_1
#SBATCH --mem=16G 
#SBATCH --ntasks=4
#SBATCH -e pixy_chr1_1_%A_%a.err 
...
pixy --stats pi --vcf /home/jamcgirr/ph/data/combine_gvcfs/mpileup/allsites_calls_chr1_1.vcf.gz --variant_filter_expression 'DP>=1' --invariant_filter_expression 'DP>=0' --zarr_path /home/jamcgirr/ph/data/combine_gvcfs/mpileup/angsd_test/zarr --window_size 50000 --populations /home/jamcgirr/ph/data/combine_gvcfs/mpileup/samples_dots.txt --outfile_prefix output_pixy/pixy_out
...
#run: sbatch script_pixy_chr1_1.sh
