...
vcftools --gzvcf /home/jamcgirr/ph/data/combine_gvcfs/population_SS06_snps.vcf.gz --max-missing 0.5 --recode-INFO-all --recode --stdout | bgzip -c > /home/jamcgirr/ph/data/combine_gvcfs/population_SS06_filtered_snps.vcf.gz 
