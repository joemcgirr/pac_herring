...
#SBATCH --job-name=06_CollectWgsMetrics
#SBATCH --mem=8G 
#SBATCH --ntasks=1 
#SBATCH -e 06_CollectWgsMetrics_%A_%a.err 
...
for file in /home/eoziolor/phpopg/data/align/06*.bam
do
...
#command to run: sbatch script_06_CollectWgsMetrics.sh