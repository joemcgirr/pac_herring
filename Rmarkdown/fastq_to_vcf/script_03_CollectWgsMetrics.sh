...
#SBATCH --job-name=03_CollectWgsMetrics
#SBATCH --mem=8G 
#SBATCH --ntasks=1 
#SBATCH -e 03_CollectWgsMetrics_%A_%a.err 
...
for file in /home/eoziolor/phpopg/data/align/03*.bam
do
...
#command to run: sbatch script_03_CollectWgsMetrics.sh