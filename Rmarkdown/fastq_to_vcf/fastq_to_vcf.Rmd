...
# Summary
This notebook is an R markdown file that generates scripts to create a `.vcf` file for 1000+ Pacific herring samples (low coverage whole genomes). The markdown file can be found [here](https://github.com/joemcgirr/pac_herring/blob/master/Rmarkdown/fastq_to_vcf/Pacific_Herring_fastq_to_vcf.Rmd)
