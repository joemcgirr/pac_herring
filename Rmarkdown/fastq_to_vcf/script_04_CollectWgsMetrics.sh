...
#SBATCH --job-name=04_CollectWgsMetrics
#SBATCH --mem=8G 
#SBATCH --ntasks=1 
#SBATCH -e 04_CollectWgsMetrics_%A_%a.err 
...
for file in /home/eoziolor/phpopg/data/align/04*.bam
do
...
#command to run: sbatch script_04_CollectWgsMetrics.sh