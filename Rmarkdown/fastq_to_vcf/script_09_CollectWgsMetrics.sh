...
#SBATCH --job-name=09_CollectWgsMetrics
#SBATCH --mem=8G 
#SBATCH --ntasks=1 
#SBATCH -e 09_CollectWgsMetrics_%A_%a.err 
...
for file in /home/eoziolor/phpopg/data/align/09*.bam
do
...
#command to run: sbatch script_09_CollectWgsMetrics.sh