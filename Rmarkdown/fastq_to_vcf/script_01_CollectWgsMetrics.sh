...
#SBATCH --job-name=01_CollectWgsMetrics
#SBATCH --mem=8G 
#SBATCH --ntasks=1 
#SBATCH -e 01_CollectWgsMetrics_%A_%a.err 
...
for file in /home/eoziolor/phpopg/data/align/01*.bam
do
...
#command to run: sbatch script_01_CollectWgsMetrics.sh