...
# snp <-read.delim("C:/Users/jmcgirr/Documents/Whitehead_Lab/ph/angsd/SFS/fst/fixed_pws_persite/snp_table_VEP.txt", header =FALSE)
# head(snp)
...
# #write.table(snp, "C:/Users/jmcgirr/Documents/Whitehead_Lab/ph/angsd/SFS/fst/fixed_pws_persite/snp_table_VEP_standard_format.txt", col.names = FALSE, row.names = FALSE, sep = "\t", quote = FALSE)
...
pop <- "PWS91"
maf <-read.delim(paste("C:/Users/jmcgirr/Documents/Whitehead_Lab/ph/angsd/SFS/fst/fixed_pws_persite/maf_for_vep/",pop,"_vcf.mafs", sep = ""), header =TRUE)
...
maf1 <-read.delim(paste("C:/Users/jmcgirr/Documents/Whitehead_Lab/ph/angsd/SFS/fst/fixed_pws_persite/maf_for_vep/",pop,"_vcf.mafs", sep = ""), header =TRUE)
