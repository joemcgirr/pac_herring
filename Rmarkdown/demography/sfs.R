...
sfs <- read.table("C:/Users/jmcgirr/Documents/Whitehead_Lab/ph/sfs/maf01/PWS07_folded.sfs", header = FALSE, stringsAsFactors = FALSE)
...
sfs <- read.table("C:/Users/jmcgirr/Documents/Whitehead_Lab/ph/sfs/downsample_41/unfolded/SS17_minQ20_minMQ30_unfolded.sfs", header = FALSE, stringsAsFactors = FALSE)
sfs <- as.vector(colSums(sfs))
barplot(sfs[-c(1,length(sfs))]) #plot variable sites 
...
sfs <- read.table("C:/Users/jmcgirr/Documents/Whitehead_Lab/ph/moments/downsample/chr1_5mb/PWS17_folded.sfs", header = FALSE, stringsAsFactors = FALSE)
sfs <- as.vector(colSums(sfs))
barplot(sfs[-c(1,length(sfs))]) #plot variable sites 
sfs <- read.table("C:/Users/jmcgirr/Documents/Whitehead_Lab/ph/moments/downsample/chr1_5mb/TB17_folded.sfs", header = FALSE, stringsAsFactors = FALSE)
sfs <- as.vector(colSums(sfs))
barplot(sfs[-c(1,length(sfs))]) #plot variable sites 
...
# light snp call
sfs <- read.table("C:/Users/jmcgirr/Documents/Whitehead_Lab/ph/sfs/light_snp_call/TB17_folded.sfs", header = FALSE, stringsAsFactors = FALSE)
sfs <- as.vector(colSums(sfs))
barplot(sfs[-c(1,length(sfs))]) #plot variable sites 
