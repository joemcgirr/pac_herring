...
The reason these analyses are 'exploratory': the 1D and 2D sfs look strange even without a minor allele frequency threshold. It's likely because low coverage data leads to an overestimate of singletons, doubletons, etc. 
