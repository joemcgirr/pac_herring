...
params <- read.delim("C:/Users/jmcgirr/Documents/Whitehead_Lab/ph/moments/moments_pipeline/test/V1.sym_mig.optimized.txt")
...
print(params$optimized_params...[1])
...
L <- 10000     # number of snps analyzed
...
sim_data <- read.delim("/Users/dan/Dropbox/Goodness_of_Fit/Empirical/Simulation_Results.txt", header = TRUE, sep = "\t")
emp_data <- read.delim("/Users/dan/Dropbox/Goodness_of_Fit/Empirical/Empirical.sym_mig.optimized.txt", header = TRUE, sep = "\t")
