...
pop_names <-  c("BC17","CA17","PWS17","PWS91","PWS96","SS06","SS17")

#pop_name <- "BC17"

for (pop_name in pop_names){
sfs <- read.table(paste("C:/Users/jmcgirr/Documents/Whitehead_Lab/ph/angsd/downsample_41/sfs/unfolded/chunks/",pop_name,"_minQ20_minMQ30_unfolded.sfs",sep = ""), header = FALSE, stringsAsFactors = FALSE)
sfs
sfs <- as.vector(colSums(sfs))
barplot(sfs[-c(1,length(sfs))]) #plot variable sites 
write.table(t(sfs),paste("C:/Users/jmcgirr/Documents/Whitehead_Lab/ph/angsd/downsample_41/sfs/unfolded/",pop_name,"_minQ20_minMQ30_unfolded.sfs",sep = ""), quote = FALSE, row.names = FALSE, col.names = FALSE)
}
