...
This notebook analyzes allele frequency shifts between Pacific Herring samples collected in 1991, 1996, 2006-7, and 2017. The summary statistic ∆z is the difference in arcsine square-root transformed minor allele frequencies (Following methods used for the [Longshanks experiment](https://elifesciences.org/articles/42014#s4)). 
...
dec <- nrow(decreased_freq)
remain <- nrow(freqs_win)-(inc+dec)
pie(c(inc,dec,remain), col = c(red, blu, yel), main = pop,
    labels = c(paste(round(inc/nrow(freqs_win),3)*100, "%", sep = ""),
               paste(round(dec/nrow(freqs_win),3)*100, "%", sep = ""),
               paste(round(remain/nrow(freqs_win),3)*100, "%", sep = "")))
...
top_increased# / nrow(freqs_win)
print(paste(pop,"decreased"))
top_decreased# / nrow(freqs_win)

print(hist(c(top_increased$zt01_mean,
...
up_dn_dn <- freqs_win[freqs_win$zt01_mean >= quantile(freqs_win$zt01_mean, .9)[[1]] &
                               freqs_win$zt12_mean <= quantile(freqs_win$zt12_mean, .1)[[1]] &
                               freqs_win$zt23_mean <= quantile(freqs_win$zt23_mean, .1)[[1]],]
...
dn_up_up <- freqs_win[freqs_win$zt01_mean <= quantile(freqs_win$zt01_mean, .1)[[1]] &
                               freqs_win$zt12_mean >= quantile(freqs_win$zt12_mean, .9)[[1]] &
                               freqs_win$zt23_mean >= quantile(freqs_win$zt23_mean, .9)[[1]],]
