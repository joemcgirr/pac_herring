...
This notebook generates scripts to estimate genome-wide summary statistics (nucleotide diversity, Tajima's D, Fst, Dxy, population branch statistic) from a `.vcf` with ANGSD and visualize results. 
...
following workflow from [here](https://doi.org/10.1093/bioinformatics/btz200) with [this script](https://github.com/mfumagalli/ngsPopGen/blob/master/scripts/calcDxy.R)
